<?php
    ...
    $sql = "select mem_idx,mem_userid,mem_name,mem_hp,mem_email,mem_hobby,mem_ssn1,mem_ssn2,mem_zipcode,mem_address1,mem_address2,mem_address3 from tb_member where mem_idx='$mem_idx'";
    ...
    // 데이터를 가져옴
    // HTML 요소에 데이터를 저장
    // 수정완료 버튼을 누르면 데이터를 update
    // infoP.php에서 update 후 info.php로 돌아옴
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <form name="regform" id="regform" method="post" action="infoP.php" onsubmit="return sendit()">
        ...
        <p><label>우편번호 : <input type="text" name="zipcode" value="<?=$zipcode?>"
        readonly id="sample6_postcode"></label> <input type="button" value="우편번호 검색" onclick="sample6_execDaumPostcode()"></p>
